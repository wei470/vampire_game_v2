...
public class BossHealthBarHUD : MonoBehaviour
{
    ...
    private GUIStyle _bossNameStyle;
    ...
    private void OnGUI()
    {
        ...
        GUI.Label(new Rect(x, y - 4, _barWidth, _barHeight), $"★ {_cachedBoss.name}  {dmg.CurrentHp}/{dmg.MaxHp} ★", _bossNameStyle);
    ...
    private void EnsureStyles()
    {
        ...
        _bossNameStyle = new GUIStyle(GUI.skin.label)
        {
            fontSize = 20,
