...
public static class DamageBreakdownUI
{
    ...
    public static string FormatDamage(long dmg) => UIFormatUtils.FormatDamage(dmg);

    public static string FormatTime(float seconds) => UIFormatUtils.FormatTime(seconds);
}