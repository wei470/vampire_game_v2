...
public class LevelUpUI : MonoBehaviour
{
    ...
    private void InitGenerator()
    {
        ...
        _generator.Init(_magePassive, _mageUpgradeConfig, _currentCharacter, _customUpgradeStacks);
    }
    ...
    private void ShowLevelUpUI()
    {
        ...
        else _generator.Init(_magePassive, _mageUpgradeConfig, _currentCharacter, _customUpgradeStacks);
    ...
    {
        if (_magePassive == null) _magePassive = GameReferences.Player?.GetComponent<MagePassive>();
        if (_magePassive != null) _magePassive.ApplyUpgrade(option.upgradeId);
        else DebugHelper.LogError("[LevelUpUI] MagePassive not found");
    }
