    ...
    private void OnEnable()
    {
        ...
        if (upgradeEntries == null || upgradeEntries.Length == 0)
        {
            upgradeEntries = new UpgradeEntry[]
            {
                ...
                new UpgradeEntry { upgradeId = "haste", upgradeName = "急速 (Haste)", description = "攻速+15%", category = CharacterUpgradeOption.UpgradeCategory.AttackSpeed, value1 = 0.15f, maxStacks = 0 },
                new UpgradeEntry { upgradeId = "barrage", upgradeName = "弹幕 (Barrage)", description = "子弹+1", category = CharacterUpgradeOption.UpgradeCategory.BulletCount, value1 = 1f, maxStacks = 0 },
