...
public class DebugPoolMonitor : MonoBehaviour
{
    ...
    private readonly List<string> _tempSortedKeys = new List<string>(32);
    ...
    private void OnGUI()
    {
        ...
        // 按池名称排序显示
        _tempSortedKeys.Clear();
        _tempSortedKeys.AddRange(_statsCache.Keys);
        _tempSortedKeys.Sort();

        foreach (string poolKey in _tempSortedKeys)
        {
